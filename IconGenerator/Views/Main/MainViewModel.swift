...
class MainViewModel: NSObject, ObservableObject {
    ...
    private let iconGeneratorService = IconFileGeneratorService(
        fileServicee: FileIconService(),
        resizeService: IconResizerService()
    )
    ...
    var isExportButtonDisabled: Bool {
        isAllExportOptionsDisabled || isToggleOptionsDisabled || isExportingInProgress
    }
    
    private var selectedExportAppIconTypes: [AppIconType] {
